...
export interface Client  { id: number; client_code: string; name: string; country: ClientRef | null; market: ClientRef | null; company_id: number | null; default_language: string; is_active: boolean; notes: string | null; created_at: string; active_template: ActiveTemplateRef | null }
...
export interface QualityStandard { id: number; client_id: number; company_id: number | null; market_id: number | null; product_id: number; variety_id: number | null; packaging_type_id: number | null; category: string | null; parameter_code: string; parameter_name: string; parameter_group: string | null; min_value: string | null; max_value: string | null; unit: string | null; severity: string; score_system: string | null; effective_from: string; effective_to: string | null; is_active: boolean }
export interface ScoreRule { id: number; client_id: number | null; company_id: number | null; market_id: number | null; parameter_code: string; score_type: string; score_label: string; min_value: string | null; max_value: string | null; unit: string | null; meaning: string | null; created_at: string }
